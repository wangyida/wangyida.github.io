...
\name{Yida}{WANG}
\address{Lillweg 13, München, Deutschland}
...
\position{Doktorand{\enskip\cdotp\enskip}Informatik und Informationswissenschaft} % Your expertise/fields
%\quote{``Proudly Enrolled in PRIS Lab of BUPT."} % A quote or statement

\makecvfooter{\today}{Yida Wang~~~2019~~~Lebenslauf}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
