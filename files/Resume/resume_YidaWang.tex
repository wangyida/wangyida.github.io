...
\name{Yida}{WANG}
\address{Lillweg 13, Munich, Germany}
...
\position{Ph.D student{\enskip\cdotp\enskip}Computer Vision and Machine Learning} % Your expertise/fields
%\quote{``Proudly Enrolled in PRIS Lab of BUPT."} % A quote or statement

\makecvfooter{\today}{Yida Wang~~~2019~~~Résumé}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
